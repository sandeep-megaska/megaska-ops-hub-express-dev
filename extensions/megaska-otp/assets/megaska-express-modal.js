(function () {
  ...
  function paymentIconChips(labels) { return labels.map((label) => `<span class="megaska-express-pay-chip">${escapeHtml(label)}</span>`).join(""); }
