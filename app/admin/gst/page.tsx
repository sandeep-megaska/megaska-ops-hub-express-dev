...
export default function GstPage() {
  return (
    <GstShell
      ...
      subtitle="Sync Shopify orders, review GST readiness, generate shipment invoices, print branded invoice copies, and export CA-ready registers."
    >
      <div className="mb-6 grid gap-4 md:grid-cols-3">
        <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-sm text-gray-600">Choose a period, pull orders into the GST import queue, and resolve readiness issues.</p>
        </div>
        <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-sm text-gray-600">Select ready orders and create GST invoices using the existing GST numbering and tax engine.</p>
        </div>
        <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
