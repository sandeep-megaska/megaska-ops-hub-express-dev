...
type PageProps = { params: Promise<{ id: string }>; searchParams?: Promise<PromotionEmbeddedContext & { hmac?: string | string[]; saved?: string; error?: string; publication?: string; sync?: string; compile?: string }> };
