...
export default function PromotionForm({ shopId, embeddedContext, rule }: { shopId: string; shopDomain: string; embeddedContext: PromotionEmbeddedContext; rule?: PromotionRuleRecord | null }) {
  ...
  return <div className="space-y-4">
    ...
    <form action={saveAction} onSubmit={() => setDirty(false)} className="space-y-6 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
      ...
      <PromotionFormSection title="Execution status"><p className="rounded-lg bg-amber-50 p-3 text-sm text-amber-800 md:col-span-2">Rule status: {rule?.status || "DRAFT"}. Not compiled. Storefront unavailable until later phases.</p></PromotionFormSection>
