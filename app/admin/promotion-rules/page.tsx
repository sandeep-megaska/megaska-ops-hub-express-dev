  ...
  try {
    ...
    if (intent === "upsert") {
      const rule = normalizePromotionRule({
        ...
        eligibility: { match: getString(formData, "match"), triggers: [{ type: getString(formData, "triggerType"), value: getString(formData, "triggerType") === "cart_contains_product" ? getString(formData, "triggerProductGid") : getString(formData, "triggerType") === "cart_contains_collection" ? getString(formData, "triggerCollectionGid") : getString(formData, "triggerValueText"), productGid: getString(formData, "triggerProductGid"), collectionGid: getString(formData, "triggerCollectionGid"), product: { gid: getString(formData, "triggerProductGid"), title: getString(formData, "triggerProductTitle"), imageUrl: getString(formData, "triggerProductImageUrl"), handle: getString(formData, "triggerProductHandle") }, collection: { gid: getString(formData, "triggerCollectionGid"), title: getString(formData, "triggerCollectionTitle"), imageUrl: getString(formData, "triggerCollectionImageUrl"), handle: getString(formData, "triggerCollectionHandle") } }] },
        reward: { type: "offer_product", productGid: getString(formData, "offerProductGid"), variantGid: getString(formData, "offerVariantGid"), quantity: getString(formData, "quantity"), requiresDiscountEnforcement: getBool(formData, "requiresDiscountEnforcement"), product: { gid: getString(formData, "offerProductGid"), title: getString(formData, "offerProductTitle"), imageUrl: getString(formData, "offerProductImageUrl"), handle: getString(formData, "offerProductHandle"), variantGid: getString(formData, "offerVariantGid"), variantTitle: getString(formData, "offerVariantTitle") } },
