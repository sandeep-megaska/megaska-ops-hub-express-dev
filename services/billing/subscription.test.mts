...
test("schema has no billing period or rated-usage models yet", () => {
  assert.doesNotMatch(schema, /model MerchantBillingPeriod|model MerchantRatedUsage|model BillingInvoice|model BillingBatch|model SubscriptionAudit|model Entitlement/);
});
