...
const emptyRequests = (): DashboardOrderRequestSnapshot => ({ cancellation: null, exchange: null, issue: null, cancellations: [], exchanges: [], issues: [], timeline: [], activeConflict: null });
